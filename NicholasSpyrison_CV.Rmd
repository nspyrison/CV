...
library(RefManageR)
# RefManageR::PrintBibliography(bib, .opts = list(), start = 1, end = length(bib))
z<-RefManageR::ReadBib("./nssPubs.bib")
# class(z)
# str(z)
# z[2]
# nssPubs_bib <- bibtex::read.bib(paste0(getwd(),"/nssPubs.bib"))
# biblio <- bibtex::read.bib("my-biblio-database.bib")

PrintBibliography(z, .opts = list(style = "latex",
