...
x <- tribble(
  ~Start, ~End, ~Text,
  2018, "\\textit{2021}", "\\textit{Ph.D. Information Technology} 
...
x <- tribble(
  ...
  NA, NA, "\\hspace{5 mm} $\\bullet~~$ Weekly metric/KPI presentations to lower and mid management",
...
tribble(
  ...
  2018, "UseR 2018! Datathon, 3rd place, of 5 teams, for a temporal-spatial shiny dashboard of avian sightings in Australia",
...
# Research summary
  ...
  * Visualization of multivariate spaces
      * Between 2018 and 2021 (expected) I researched high dimensional visualization especially through animates across changing bases with various visualization tours
...
<!-- $\nsKeyword{data analysis, high dimensional visualization}$ -->
<!-- ## above prints with no spaces, how to print a string in latex math env? -->
